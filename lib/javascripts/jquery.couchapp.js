...
(function($) {
  ...
  //
  // Modified by hpoydar to allow ajax_opts to be passed 
  // to the view function in jquery.couchapp.js
  //
  function Design(db, name) {
    this.view = function(view, opts, ajax_opts) {
      db.view(name+'/'+view, opts, ajax_opts);
    };
  };
